...
export default async function Header() {
    ...
    return <header className="fixed top-0 h-16 border-b w-full bg-white">
        <div className="w-full h-full flex items-center justify-between max-w-screen-xl mx-auto px-2 lg:px-0">
            ...
            <div className="flex items-center justify-center mx-2 sm:mx-0 sm:w-[180px] gap-1 sm:gap-0">
                <Link href="/login" className="sm:hidden sm:mx-0">
                    <Button variant="ghost" className="flex text-base p-1 px-3"><UserOutlined style={{ fontSize: "16px" }} /></Button>
                </Link>
                ...
                <Link href="/cart">
                    <Button variant="ghost" className="flex w-full h-full gap-0.5 text-base p-1 py-2.5 sm:mx-0 sm:py-1.5 sm:px-4">
